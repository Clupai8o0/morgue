...
CREATE INDEX "auth_attempts_email_idx" ON "auth_attempts" USING btree ("email","at");--> statement-breakpoint
CREATE INDEX "auth_attempts_ip_idx" ON "auth_attempts" USING btree ("ip_hash","at");--> statement-breakpoint
